...
<div class="vote" style="margin-top: 10px;position:absolute;top: 300px;height: 70%;;overflow: scroll;">
    <div class="voter">
        <ul style="width: 100%;list-style: none">
            <?php if(is_array($vote)): foreach($vote as $k=>$vote): ?><li style="width: 100%;font-size: 26px">
                        ...
                        <tr>
                            ...
                            <td style="width: 15%;">
                                <form action="add_vote" method="post">
                                    ...
                                    <button type="submit" style="width: 80%;height: 40px;font-size: 28px" onclick="vote(this,true)">投票</button>
                                </form>
                            </td>
                        </tr>
                    </table>
                </li><?php endforeach; endif; ?>
            <li style="width: 100%;font-size: 26px">
                <table style="width: 100%;height: 30%;">
                    <tr>
                        <td style="width: 30%;">
                            <a>
                                <img src="/movie/Public/image/chelizi.jpg" class="image">
                            </a>
                        </td>
                        <td style="width:35%;text-align: left">
                            <a>某先生：</a><br>
                            <p style="font-size: 24px">医学专家，为人民服务30年！</p>
                        </td>
                        <td style="width:20%;text-align: left">
                            <table>
                                <tr>
                                <tr>
                                    <td style="text-align: center"><span style="font-size: 30px">0</span>票</td>
                                </tr>
                                <tr>
                                    <td style="text-align: center">
                                        当前排名：20
                        ...
                        <td style="width: 15%;">
                            <button style="width: 80%;height: 40px;font-size: 28px" onclick="vote(this,true)">投票</button>
                        </td>
                    </tr>
                </table>
            </li>
            <li style="width: 100%;font-size: larger">
                <table style="width: 100%;height: 30%;">
                    <tr>
                        <td style="width: 30%;">
                            <a>
                                <img src="/movie/Public/image/chelizi.jpg">
                            </a>
                        </td>
                        <td style="width:60%;text-align: left">
                            <p style="font-size: 24px">某女士：</p>
                        </td>
                        <td style="width: 10%">
                            <button style="width: 100%;height: 20%" onclick="vote(this,true)">投票</button>
                        </td>
                    </tr>
                </table>
            </li>
            <li style="width: 100%;font-size: larger">
                <table style="width: 100%;height: 30%;">
                    <tr>
                        ...
                        <td style="width:60%;text-align: left">
                            <p>啊实打实地方阿斯顿发达案发生地方啊实打实地方阿斯顿发达案发生地方啊实打实地方阿斯顿发达案发生地方啊实打实地方阿斯顿发达案发生地方啊实打实地方阿斯顿发达案发生地方</p>
                        </td>
                        <td style="width: 10%">
                            <button style="width: 100%;height: 20%" onclick="vote(this,true)">投票</button>
                        </td>
